...
local warning_msg_icon = WIDGET_DIR .. '/spaceman.jpg'
local warning_msg_title = 'Huston, we have a problem'
...
--     awful.spawn.easy_async([[bash -c 'cat /sys/class/power_supply/BAT1/capacity']], function(stdout, _, _, _)
--         charge = tonumber(string.match(stdout, '%d?%d?%d'))

--         awful.spawn.easy_async([[bash -c 'cat /sys/class/power_supply/BAT1/status']], function(stdout, _, _, _)
                                ...
                                awful.key({ modkey }, "b", function ()
                                    ...
                                    awful.key({ modkey }, "w", function ()
                                        ...
                                        awful.key({ modkey }, "q", function ()
                                            awful.util.spawn("/var/lib/flatpak/app/com.spotify.Client/x86_64/stable/51df931abc1fca310d736d61acd178f063d98f63d5b4a769c2c15eff5234c8c3/export/bin/com.spotify.Client") end),
